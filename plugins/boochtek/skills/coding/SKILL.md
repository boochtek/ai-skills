...
- Reuse existing patterns and abstractions rather than creating new ones
...
Avoid ad hoc string manipulation or regular expressions when the data requires something more appropriate.
